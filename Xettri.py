...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓Niraj Thalal Xettri            ║║
║  GITHUB 💝💝💝 Niraj928356   ║ ║
║ FACEBOOK 💝💝💝 Nepali Termux Command║ ║
║  ENJOY 💝💝💝Nepal cloning                ║ ║
║   Note 💝💝💝  ║ ║वाइफाइ  र  डाटा  ले काम गर्छ 
╚══──────────────────────────╝─══╝
...
""")
CorrectUsername = Niraj
CorrectPassword = Xettry
...
def Zeek():
    ...
    print '\x1b[1;96m ════RK'
    time.sleep(0.10)
    print '\x1b[1;97m════Niraj Thalal Xettri 
    time.sleep(0.10)
